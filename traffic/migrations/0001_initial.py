# Generated by Django 2.1.4 on 2019-01-22 09:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Expired', 'expired'), ('Accepted', 'accepted'), ('New', 'new'), ('Pending', 'pending')], default='New', max_length=120)),
            ],
        ),
        migrations.CreateModel(
            name='CarImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('No Response', 'No Response'), ('Declined', 'Declined'), ('Accepted', 'Accepted')], default='No Response', max_length=120)),
                ('accident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='traffic.Accident')),
            ],
        ),
        migrations.CreateModel(
