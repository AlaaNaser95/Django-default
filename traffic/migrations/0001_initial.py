# Generated by Django 2.1.4 on 2018-12-21 12:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Expired', 'expired'), ('New', 'new'), ('Pending', 'pending'), ('Accepted', 'accepted')], default='New', max_length=120)),
                ('status_for_staff', models.CharField(blank=True, choices=[('Declined', 'declined'), ('Accepted', 'accepted')], max_length=120, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CarImage',
